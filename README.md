...
`pip install git+https://github.com/biomodels/BIOMD0000000131.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/BIOMD0000000131.git@20140916`

## Usage

Importing the model package.

`import BIOMD0000000131 as model`
...
Neurons?_ Figure1(N) rebound burst has been reproduced by MathSBML. The ODE
...
parameters and different stimulus function or events. a=0.03; b=0.25; c=-52;
d=0;V=-64; u=b*V;
